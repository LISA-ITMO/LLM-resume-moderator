    ...
    Parses a string response to extract reasoning and JSON result.
        ...
        Args:
            response_str: The string containing the reasoning and JSON result,
                          formatted with "Рассуждения:" and "Результат:" delimiters,
                          and the JSON enclosed in ```json ... ``` tags.

        Returns:
            A ResponseWithReasoning object containing the extracted reasoning and result dictionary.
            If the JSON is invalid, the result dictionary will contain an error message.
    """
...
async def moderate(
    ...
    Moderates a resume based on provided rules and a language model.
        ...
        Returns:
            ResponseWithReasoning: An object containing the moderation response and reasoning.
    """
