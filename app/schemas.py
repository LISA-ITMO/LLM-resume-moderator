...
class ModeratorResponse(BaseModel):
    ...
    Represents the response from a moderation check.
        ...
        This class encapsulates the status of a content moderation decision and
        details about any rules that were violated.

        Attributes:
            status: Indicates whether the content was approved or rejected.
            violated_rules: A list of rule identifiers that were triggered.
    """
