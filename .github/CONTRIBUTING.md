# Contributing to LLM-resume-moderator

We welcome you to [check the existing issues](https://github.com/LISA-ITMO/LLM-resume-moderator/issues) for bugs or enhancements to work on.
If you have an idea for an extension to LLM-resume-moderator, please [file a new issue](https://github.com/LISA-ITMO/LLM-resume-moderator/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/LISA-ITMO/LLM-resume-moderator/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/LLM-resume-moderator.git
   ```
...
Finally, go to the web page of your fork of the LLM-resume-moderator repo, and click
...
If your contribution changes LLM-resume-moderator in any way:

- Update the [documentation](https://github.com/LISA-ITMO/LLM-resume-moderator/tree/main/data/docs) so all of your changes are reflected there.

- Update the [README](https://github.com/LISA-ITMO/LLM-resume-moderator/tree/main/README.md) if anything there has changed.
